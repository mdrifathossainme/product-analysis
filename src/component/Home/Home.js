      ...
      <>
        <div className='home-content grid md:grid-cols-2 sm:grid-cols-1 gap-8 lg:py-20'>
            <div className="right-part lg:my-20 md:ml-10 md:mt-12 lg:pl-20">
               <h1 className='lg:text-7xl md:text-5xl  sm:text-2xl font-bold ' >Your Next Car</h1>
               <h1 className='lg:text-7xl md:text-5xl font-bold lg:mt-6 md:mt-3 text-red-600'>Your Best Car</h1>
               <p  className='mt-12 lg:text-xl md:text-sm'>After the CHIRON and CHIRON Sport, the CHIRON Pur Sport showed the ferocious personality of a hyper sports car made for corners and lateral agility. Now, with the CHIRON Super Sport, we are following our long tradition of combining extreme high speed with absolute luxury, to offer a whole new dimension of the BUGATTI experience</p>
             <div className='mt-12'>
         ...
         <img className='lg:w-full md:w-80 md:mt-20 pr-12' src={img} alt="rge" />
            </div>
        </div>
        <div className="review md:mt-20">
            <h1 className='text-center lg:text-6xl md:text-3xl md:mt-12 uppercase font-semibold tracking-widest	'>Customer Review</h1>
